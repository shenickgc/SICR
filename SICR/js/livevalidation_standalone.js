...
var Validate = {
    ...
    Numericality: function(value, paramsObj){
        ...
        var notANumberMessage = paramsObj.notANumberMessage || "Tiene que ser un numero";
        var notAnIntegerMessage = paramsObj.notAnIntegerMessage || "Tiene que ser entero";
    	var wrongNumberMessage = paramsObj.wrongNumberMessage || "Must be " + is + "!";
    	var tooLowMessage = paramsObj.tooLowMessage || "No menos de " + minimum + "!";
    	var tooHighMessage = paramsObj.tooHighMessage || "No mas de " + maximum + "!";
   ...
   *                           (DEFAULT: false)
    ...
    Format: function(value, paramsObj){
      ...
      var paramsObj = paramsObj || {};
      var message = paramsObj.failureMessage || "Incorrecto";
