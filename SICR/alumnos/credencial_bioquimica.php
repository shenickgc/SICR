...
<body>
	...
	$sql = "select * from aspirantes where carrera = 'bioquimica'";
			...
			echo "<div class='col s12 m8 l9'>";
                    ...
                    echo "<div class='card-image'>
                    		...
                    		<table>                    			
                    			...
                    			<tr>
                    				<td>
                    				<p style='font-size: 15px;'>" . 'VIGENCIA:' . "</p></br>
                    				<p style='font-size: 12px;'>" . 'ROCÍO CONTRERAS JIMÉNEZ' . "</br></br></br>" . 'JEFA DEL DEPARTAMENTO' . "</br>" . 'DE DESARROLLO ACADÉMICO' . "</p></br></br>
                    				</br><p style='font-size: 12px;'>" . 'FIRMA DEL ALUMNO' . "</br>" . '_________________________' . "</p>
                    				</td>
                    			</tr>
