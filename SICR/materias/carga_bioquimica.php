	...
	while($fila = pg_fetch_array($resultado)) 
		{
            ...
            echo "<div class='card-content'>
                    ...
                    <p style='font-size: 15px;'>Materias: " . $fila['nombre_materia'] . "</p>
                    <p style='font-size: 15px;'>Horario: " . $fila['horario'] . "</p>
                    <p style='font-size: 15px;'>Salón: " . $fila['aula'] . "</p></br>
